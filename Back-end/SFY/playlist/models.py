...
class Playlist(models.Model):
    ...
    picture = models.ImageField(_("playlist image"), blank=True)
    ...
    is_private = models.BooleanField(_("is private"), blank = True, default=True)
    
    followers = models.ManyToManyField(CustomUser, blank=True, related_name="followed_playlists",)
